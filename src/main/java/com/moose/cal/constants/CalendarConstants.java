...
*****************************************************************************/
package com.moose.cal.constants;
...
public final class CalendarConstants {
  ...
  public final static class GregorianCalendarConstants {
    ...
    public static final String[] _eras = {
      "BC","BCE",
      "AD","CE"
    };
  };

  public final static class FrenchRepublicanCalendarConstants {
    ...
    public final static String[] weekDayNames = {
        "Primidi",
        "Duodi",
        "Tridi",
        "Quartidi",
